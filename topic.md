#  A Hands on course on Programming with Python Level One
### 
...
|   *8.8* | *Online Quiz*            | | |
|   *9* | **Introduction to Python libraries commonly used in Industry** | **5 hours** | One hour for each module|
|   *9.1* | *Intro to Creating a simple UI in python using tkinter framework*            | | |
|   *9.2* | *Intro to Python libraries to access databases like MongoDB, MariaDB (SQL) etc*            | | |
|   *9.3* | *Intro to Mathlab plotting library*            | | |
|   *9.4* | *Intro to Data Processing (statistical library module scipy) ( Mean median mode, SD, Percentile  Scatter plot etc)*            | | |
|   *9.5* | *Intro to Rabbit MQ Message queue library*            | | |
|   *9.5* | *Online Quiz*            | | |
